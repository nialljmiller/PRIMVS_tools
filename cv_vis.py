...
class PrimvsTessCrossMatch:
    ...
    def generate_target_list(self):
        ...
        print(f"Proposal-formatted target list len: {len(proposal_targets)}")
    ...
    def run_pipeline(self):
        crossmatch_path = self.output_dir + '/tess_crossmatch_results.csv'
        target_path = self.output_dir + '/tess_proposal_targets.csv'
